    ...
    public static void main(String[] args) {
        ...
        if (status == 0) { //compute tax for single filers
            ...
            if (income <= 16700) {
                ...
                tax = 16700 * 0.1 + (67900 - 16700) * 0.15 + (137050 - 67900) * 0.25 + (208850 - 82250) * 0.28 + (income - 208850) * 0.33;
            }
            else {
                tax = 16700 * 0.1 + (67900 - 16700) * 0.15 + (137050 - 67900) * 0.25 + (208850 - 82250) * 0.28 + (372950 - 171550) * 0.33 + (income - 372950) * 0.35;
            }
